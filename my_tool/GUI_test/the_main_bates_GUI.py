...
from master_thesis.my_tool.GUI_test.optimizer_GUI import (
...
# from my_functions.transformer import ThrustToPressureTransformer
# from master_thesis.openmotor.motorlib.propellant import Propellant
import master_thesis.my_tool.GUI_test.optimizer_GUI as optimizer
...
def run_optimization(
    ...
    # Use output_dir as base, create if not exists
    ...
    print("[DEBUG_00] SAVING HISTORY TO DISK...")
    ...
    print("[DEBUG_00]  BEST SIM PRESSURE AND TIME GOTTEN")
    ...
    print("[DEBUG_00] Plotting all curves...")
    plot_all(
...
if __name__ == "__main__":
    # CLI usage: python the_main_bates_GUI.py <target_file> <motor_file> <output_dir> [pop_size] [generations]
    import argparse
    parser = argparse.ArgumentParser(description="Run Bates optimization.")
    ...
    parser.add_argument("--generations", type=int, default=75, help="Number of generations")
