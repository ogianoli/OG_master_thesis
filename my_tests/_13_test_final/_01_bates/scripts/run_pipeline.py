...
def run_pipeline(csv_path = ""):
    # === RUN CLASSIFICATION ===
    data_num = get_next_data_num(base_path="master_thesis/my_tests/_13_test_final/_01_bates/data/")
    output_dir = get_valid_data_dir(data_num, base_path="master_thesis/my_tests/_13_test_final/_01_bates/data/")
    csv_path = "master_thesis/my_tests/_13_test_final/_01_bates/results/target.csv"
    motor_file = "master_thesis/my_tests/_13_test_final/_01_bates/motor.ric"
    pop_size = 30
    generations = 50
    ...
    if predicted_class == 0:
        from the_main_bates_GUI import run_optimization as run_func
