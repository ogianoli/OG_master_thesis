...
# output_folder = "master_thesis/my_functions/LD_Ratio/star/no_fail2"
...
# csv_path = "master_thesis/my_functions/LD_Ratio/util/no_fail_dataset/no_fail_dataset_star.csv"
